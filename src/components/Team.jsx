                                        ...
                                        <div key={i} className="mb-6 w-full lg:w-1/2 px-4">
                                            <div className="flex flex-wrap items-center bg-white rounded shadow overflow-hidden">
                                                ...
                                                <div className="w-full lg:w-2/3 lg:pl-6 p-4">
                                                    <h4 className="mb-2 text-2xl font-bold font-heading text-black">{item['name']}</h4>
                                                    <p className="mb-4 text-gray-500 leading-loose">{item['bio']}</p>
                                                    <div className="flex">
                                                        <a className="mr-3" target="_blank" href={item['facebook']}>
                                                            <img src="atis-assets/social/facebook.svg" alt="" />
                                                        </a>
                                                        <Link className="mr-3" target="_blank" href={item['twitter']}>
