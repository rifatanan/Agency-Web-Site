                                        ...
                                        <div className="mb-4 w-full lg:w-1/3 px-3">
                                            <div className="p-8 bg-white rounded shadow text-center">
                                                <div className="bg-no-repeat bg-left-top" style={{backgroundImage: 'url("atis-assets/elements/quote-grey.svg")'}}>
                                                    ...
                                                    <img className="mb-2 mx-auto w-12 h-12 rounded-full object-cover" src="https://static.shuffle.dev/uploads/files/36/368971920a7783ddacbdc0de43a17896c8faed5f/360-F-299042079-vGBD7wIlSeNl7vOevWHiL93G4koMM967.jpg" alt=""/>
                                                    <h4 className="mb-1 text-2xl font-bold font-heading text-green-500">
                                                        {item['name']}
                                                    </h4>
